...
import { StyleSheet, Text, View, CheckBox, TouchableHighlight, I18nManager, Keyboard, TouchableWithoutFeedback, ActivityIndicator, Platform, Button, Input, ScrollView, TouchableOpacity, Image, TextInput, Dimensions, KeyboardAvoidingView, ImageBackground } from 'react-native';
...
class VerifyFBSignUp extends React.Component {
  ...
  async _handleSubmit() {
    await this.setState({ _checkReset: true })
    ...
    setTimeout(() => {
      ...
      if (!this.state._error) {
        ...
        authService.signUpFaceBookUser(this.state.phonenumber, this.props.navigation.state.params).then(response => {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.mainContainer}>
            ...
            <TouchableOpacity style={styles.tOpacity}
              ...
              {
                !this.state._checkReset && (<Text style={styles.text}>{I18nManager.isRTL ? "إدخال" : "SUBMIT"}</Text>)
              }
            </TouchableOpacity>
...
export default connect(mapStateToProps)(VerifyFBSignUp)