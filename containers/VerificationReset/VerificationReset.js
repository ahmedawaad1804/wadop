...
import { StyleSheet, Text, View, CheckBox, ActivityIndicator, TouchableHighlight,Keyboard,I18nManager,TouchableWithoutFeedback, Button, Input, ScrollView, TouchableOpacity, Image, TextInput, Dimensions, KeyboardAvoidingView, ImageBackground } from 'react-native';
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={{ flex: 2, alignItems: 'center', justifyContent: 'center' }}>
            <Text style={{
              fontFamily: 'Cairo-Regular',
              fontSize: 20,
            }}>{I18nManager.isRTL ? "تفعيل" : "Verification"}</Text>
          </View>
          <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
